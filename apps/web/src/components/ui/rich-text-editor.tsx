...
export const RICH_TEXT_CLASS = "dd-rich-text";
...
function LinkPopover({ editor }: { editor: Editor }) {
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="start" sideOffset={8} className="w-72 p-4">
        <form
...
function Toolbar({ editor }: { editor: Editor }) {
  return (
    <div className="flex flex-wrap items-center gap-0 overflow-x-auto border-b border-border bg-card px-1 py-0.5 sm:gap-0.5 sm:px-1.5 sm:py-1">
      <ToolbarButton
        label="Bold"
...
>(function RichTextEditor(
  ...
  const editor = useEditor(
    {
      ...
      editorProps: {
        attributes: {
          class: cn(RICH_TEXT_CLASS, "px-3 py-2.5 sm:px-4 sm:py-3"),
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 overflow-x-auto bg-card">
...
export function RichTextDisplay({
  ...
  const html = highlightPlaceholdersInHtml(
    sanitizeTemplateHtml(content),
    validPlaceholderKeys,
  );
  return (
    <div
      className={cn(RICH_TEXT_CLASS, "px-3 py-2.5 sm:px-4 sm:py-3", className)}
